...
public interface GeneralPreferencesHelper {
    ...
    String PREF_KEY_LAST_ID_PROJECT="pref_key_last_id_project";
    String PREF_KEY_LAST_ID_META="pref_key_last_id_meta";
    String PREF_KEY_LAST_ID_TAREA="pref_key_last_id_tarea";
    String PREf_KEY_SHOW_USER_NAME="pref_key_show_user_name";
    String PREF_KEY_REMEMBER_ME="pref_key_remember_me";
